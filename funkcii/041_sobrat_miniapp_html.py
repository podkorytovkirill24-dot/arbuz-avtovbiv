...
<body>
  ...
  <script>
    ...
    function renderSubmit(data){
      ...
      return `
        <div class="label">Сдать MAX-номера в очередь</div>
        <div class="field">
          <label>Тариф</label>
        ...
        <div class="field">
          <label>MAX-номера (каждый с новой строки)</label>
          <textarea class="textarea" id="submitNumbers" placeholder="79991234567\n77071234567"></textarea>
        </div>
